...
describe('workspace type tokens', () => {
  it('exposes modular text scale 12/14/18/20 without a 16 step', () => {
    ...
    expect(Object.values(workspaceType)).not.toContain(16)
  })
  ...
  it('keeps rem aliases aligned to the px scale', () => {
    ...
    expect(workspaceTypeRem).not.toHaveProperty('md')
  })
})
